...
export function createRing(scene) {
  ...
  //ring floor
  const floor = new THREE.Mesh(new THREE.BoxGeometry(8, 1, 8), floorMaterial);
  ...
  const stand1 = new THREE.Mesh(
    new THREE.BoxGeometry(18, 0.4, 1.2),
    crowdMaterial,
  );
